...
${lastUpdated && lastMessage && showUpdated ? `<footer class="${"update svelte-5tp21g"}"><a href="${"https://github.com/ShermanZero/shermanzero.com"}" target="${"_"}" class="${"svelte-5tp21g"}">LATEST BUILD</a> ON [${(0, import_index_1e54ea6c.e)(lastUpdated)}] -
    <q>${(0, import_index_1e54ea6c.e)(lastMessage)}</q></footer>` : ``}`;
});

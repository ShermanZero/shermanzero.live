...
const Project = (0, import_index_e5e312d4.c)(($$result, $$props, $$bindings, slots) => {
...
const Projects = (0, import_index_e5e312d4.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="${"wrapper svelte-oo3h4e"}">${(0, import_index_e5e312d4.v)(Project, "Project").$$render(
    $$result,
    {
